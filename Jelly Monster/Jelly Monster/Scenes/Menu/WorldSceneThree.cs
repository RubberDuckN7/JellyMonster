...
{
    public class WorldSceneThree : IScene
    {
        ...
        public WorldSceneThree(PlayerData player_data, PlayerSaveData player_save)
        {
            this.player_data = player_data;
            this.player_save = player_save;
            this.level_id = 254;

            this.player_data.world_id = 2;
        ...
        public override void Load()
        {
            ...
            background = content.Load<Texture2D>("Textures/background_forest");
            ...
            levels = SceneManager.Content.Load<MapData>("XML/Worlds/MapThree");
            ...
            for (byte i = 0; i < 21; i++)
            {
                if (player_save.scores.Count > i + 42)
                {
        ...
        public override void Draw(SpriteBatch sp)
        {
            ...
            //sp.DrawString(Fonts.FontMenu, "World three", Vector2.Zero, Color.Red);
            ...
            if (SceneState == IrisEngine.SceneState.Active && player_data.world_id == 2)
            {
