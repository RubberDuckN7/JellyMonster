...
namespace Jelly_Monster
{
    ...
    class LoadingScene : IScene
    {
        ...
        public static void Load(SceneManager smanager, bool loadingIsSlow,
                                params IScene[] scenes_to_load)
        {
            // Tell all the current screens to transition off.
            foreach (IScene scene in smanager.GetScenes())
                scene.ExitScene();
        ...
        public override void Update(float dt, bool has_focus, bool covered_by_other)
        {
            ...
            if (otherScenesAreGone)
            {
                ...
                foreach (IScene scene in scenes_to_load)
                {
                    if (scene != null)
                    {
        ...
        public override void Draw(SpriteBatch sp)
        {
            ...
            if (loadingIsSlow)
            {
                ...
                // Draw the text.
                sp.Begin();
                sp.Draw(SceneManager.LoadingTexture, SceneManager.GraphicsDevice.Viewport.Bounds, Color.White);
