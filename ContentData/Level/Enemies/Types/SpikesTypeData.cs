    ...
    public class SpikesTypeData : ContentObject
    {
		...
		public class SpikesTypeDataReader : ContentTypeReader<SpikesTypeData>
        {
                ...
                SpikesTypeData existingInstance)
            {
                ...
                desc.Spikes_Attacking.AddRange(input.ReadObject<List<string>>());
                desc.Spikes_Removing.AddRange(input.ReadObject<List<string>>());
                desc.Spikes_Waiting = input.ReadString();
